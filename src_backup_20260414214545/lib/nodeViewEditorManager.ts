...
export function getActiveInternalEditor(): Editor | null {
  console.log('[nodeViewEditorManager] getActiveInternalEditor() =>', activeInternalEditor ? '有值' : 'null');
...
export function setActiveInternalEditor(editor: Editor | null): void {
  console.log('[nodeViewEditorManager] setActiveInternalEditor(', editor ? '有值' : 'null', ')');
